...
public partial class PauseMenu : Control, IPauseMenu {
  ...
  [Node]
  public IButton SaveButton { get; set; } = default!;
  [Node]
  public IButton MainMenuButton { get; set; } = default!;
  [Node]
  public IAnimationPlayer AnimationPlayer { get; set; } = default!;
  [Node]
  public IAnimationPlayer SaveOverlayAnimationPlayer { get; set; } = default!;
  [Node]
  public IVBoxContainer SaveOverlay { get; set; } = default!;
  #endregion Nodes
